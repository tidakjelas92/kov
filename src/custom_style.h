...
// customized my own style but using dark as a base.

// Custom style name: Dark
static const GuiStyleProp darkStyleProps[DARK_STYLE_PROPS_COUNT] = {
    { 0, 0, 0x99928cff },    // DEFAULT_BORDER_COLOR_NORMAL
    { 0, 1, 0xeec881ff },    // DEFAULT_BASE_COLOR_NORMAL
    { 0, 2, 0x867971ff },    // DEFAULT_TEXT_COLOR_NORMAL
    { 0, 3, 0xeb8a1cff },    // DEFAULT_BORDER_COLOR_FOCUSED
    { 0, 4, 0xffb649ff },    // DEFAULT_BASE_COLOR_FOCUSED
    { 0, 5, 0x4f380dff },    // DEFAULT_TEXT_COLOR_FOCUSED
    { 0, 6, 0xd1750dff },    // DEFAULT_BORDER_COLOR_PRESSED
    { 0, 7, 0xea8a27ff },    // DEFAULT_BASE_COLOR_PRESSED
    { 0, 8, 0x4f380dff },    // DEFAULT_TEXT_COLOR_PRESSED
    { 0, 9, 0xa89984ff },    // DEFAULT_BORDER_COLOR_DISABLED
    { 0, 10, 0x928374ff },    // DEFAULT_BASE_COLOR_DISABLED
    { 0, 11, 0x7c6f64ff },    // DEFAULT_TEXT_COLOR_DISABLED
    { 0, 16, 0x00000010 },    // DEFAULT_TEXT_SIZE
    { 0, 17, 0x00000000 },    // DEFAULT_TEXT_SPACING
    { 0, 18, 0xa19b83ff },    // DEFAULT_LINE_COLOR
    { 0, 19, 0xf9f5d7ff },    // DEFAULT_BACKGROUND_COLOR
