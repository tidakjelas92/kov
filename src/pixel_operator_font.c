...
PRIVATE Rectangle pixel_operator_font_rects[] = {
	{ 4, 4, 4, 16 },
	{ 16, 4, 1, 9 },
	{ 25, 4, 3, 3 },
	{ 36, 4, 6, 9 },
...
PRIVATE GlyphInfo pixel_operator_font_glyphs[] = {
	{ 32, 0, 13, 4, { 0 }},
	{ 33, 2, 4, 5, { 0 }},
	{ 34, 2, 4, 7, { 0 }},
	{ 35, 1, 4, 8, { 0 }},
...
// copied from rguistyler exported header file
// since the font data is not copied, don't try to free this!
PUBLIC Font pixel_operator_font_load(void) {
// Font atlas image pixels data: DEFLATE compressed
	u8 font_data_compressed[] = { 0xed,
	...
	i32 font_data_size = 0;
	unsigned char *data = DecompressData(font_data_compressed, sizeof(font_data_compressed), &font_data_size);
	Image font_image = { data, 512, 256, 1, 2 };

	Font font = {
		.baseSize = 16,
		.glyphCount = sizeof(pixel_operator_font_glyphs) / sizeof(GlyphInfo),
		.texture = LoadTextureFromImage(font_image),
	};
	UnloadImage(font_image);

	font.recs = pixel_operator_font_rects;
	font.glyphs = pixel_operator_font_glyphs;

	SetShapesTexture(font.texture, (Rectangle){ 510, 254, 1, 1 });
